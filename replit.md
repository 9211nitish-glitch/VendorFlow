...
## Recent Updates
- **ES Module Error Fix**: Resolved "require is not defined" error by removing "type": "module" from package.json
- **Server Starting Successfully**: npm install and server startup working correctly in Plesk environment
