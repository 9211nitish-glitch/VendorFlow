...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post('/api/admin/packages', authenticateToken, requireAdmin, PackageController.validateCreatePackage, PackageController.createPackage);
  app.put('/api/admin/packages/:id', authenticateToken, requireAdmin, PackageController.validateUpdatePackage, PackageController.updatePackage);
  app.delete('/api/admin/packages/:id', authenticateToken, requireAdmin, PackageController.deletePackage);
